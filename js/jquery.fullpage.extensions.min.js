...
!function (e, n) {
    ...
    "use strict";
    var r = "fullpage-wrapper", a = "." + r, l = "fp-responsive", s = "fp-notransition", c = "fp-destroyed",
        d = "fp-enabled", f = "fp-viewing", u = "active", p = "." + u, v = "fp-completely", h = "." + v, g = ".section",
        m = "fp-section", S = "." + m, w = S + p, y = S + ":first", b = S + ":last", x = "fp-tableCell", C = "." + x,
        T = "fp-auto-height", A = "fp-normal-scroll", M = "fp-nav", k = "#" + M, O = "fp-tooltip", R = "." + O,
        z = "fp-show-active", I = ".slide", L = "fp-slide", E = "." + L, H = E + p, B = "fp-slides", D = "." + B,
        P = "fp-slidesContainer", Y = "." + P, F = "fp-table", W = "fp-slidesNav", X = "." + W, V = X + " a",
        Z = "fp-controlArrow", N = "." + Z, j = "fp-prev", q = "." + j, G = Z + " " + j, U = N + q, Q = "fp-next",
        J = "." + Q, _ = Z + " " + Q, K = N + J, $ = e(n), ee = e(t);
    e.fn.fullpage = function (Z) {
        function q(n, t) {
            ...
            Z.autoScrolling && !Z.scrollBar ? (wt.css({
                ...
                "-ms-touch-action": "",
                "touch-action": ""
            }), ft(Rt), o.length && wt.scrollTop(o.position().top)), Rt.trigger("setAutoScrolling", [n])
        }
        ...
        function ue(n) {
            if (!Rt.hasClass(c)) {
                It = !0, zt = $.height(), e(S).each(function () {
                    var n = e(this).find(D), t = e(this).find(E);
                    Z.verticalCentered && e(this).find(C).css("height", Fn(e(this)) + "px"), e(this).css("height", be(e(this)) + "px"), t.length > 1 && Tn(n, n.find(H))
                }), Z.scrollOverflow && Dt.createScrollBarForAll();
                var t = e(w), o = t.index(S);
                o && !ut("fadingEffect") && se(o + 1), It = !1, e.isFunction(Z.afterResize) && n && Z.afterResize.call(Rt), e.isFunction(Z.afterReBuild) && !n && Z.afterReBuild.call(Rt)
            }
        }
        ...
        function me(e) {
            ...
            Ut[e] = Z[e + "Key"], bt[e] = "undefined" != typeof n[t] ? new n[t] : null, bt[e] && bt[e].c(e)
        }
        ...
        function we() {
            Rt.css({
                height: "100%",
                position: "relative"
            }), Rt.addClass(r), e("html").addClass(d), zt = $.height(), Rt.removeClass(c), Te(), pt("parallax", "init"), e(S).each(function (n) {
                var t = e(this), o = t.find(E), i = o.length;
                xe(t, n), Ce(t, n), i > 0 ? ye(t, o, i) : Z.verticalCentered && Yn(t)
        ...
        function ye(n, t, o) {
            var i = 100 * o, r = 100 / o;
            t.wrapAll('<div class="' + P + '" />'), t.parent().wrap('<div class="' + B + '" />'), n.find(Y).css("width", i + "%"), o > 1 && (Z.controlArrows && Ae(n), Z.slidesNavigation && jn(n, o)), t.each(function (n) {
        ...
        function Me() {
            ...
            for (var t = 0; t < e(S).length; t++) {
                ...
                var i = '<li><a href="#' + o + '"><span></span></a>', r = Z.navigationTooltips[t];
        ...
        function ze() {
            var n = e(w);
            n.addClass(v), en(n), nn(n), Z.scrollOverflow && Z.scrollOverflowHandler.afterLoad(), Ie() && e.isFunction(Z.afterLoad) && Z.afterLoad.call(n, n.data("anchor"), n.index(S) + 1), e.isFunction(Z.afterRender) && Z.afterRender.call(Rt)
        }
        ...
        function Ee() {
            ...
            if ((!Z.autoScrolling || Z.scrollBar || ut("dragAndMove")) && !ht()) {
                var i = ut("dragAndMove") ? o.abs(bt.dragAndMove.getCurrentScroll()) : $.scrollTop(), r = (Be(i), 0),
                    a = i + $.height() / 2,
                    l = ut("dragAndMove") ? bt.dragAndMove.getDocumentHeight() : yt.height() - $.height(), s = l === i,
                    c = t.querySelectorAll(S);
                if (s) r = c.length - 1; else if (i) for (var d = 0; d < c.length; ++d) {
                    var f = c[d];
                    f.offsetTop <= a && (r = d)
                } else r = 0;
                if (n = e(c).eq(r), !n.hasClass(u)) {
                    Qt = !0;
                    var p, v, h = e(w), g = h.index(S) + 1, m = Dn(n), y = n.data("anchor"), b = n.index(S) + 1,
                        x = n.find(H);
                    x.length && (v = x.data("anchor"), p = x.index()), Et && (n.addClass(u).siblings().removeClass(u), pt("parallax", "afterLoad"), e.isFunction(Z.onLeave) && Z.onLeave.call(h, g, b, m), e.isFunction(Z.afterLoad) && Z.afterLoad.call(n, y, b), Z.resetSliders && bt.resetSliders && bt.resetSliders.apply({
                        localIsResizing: It,
                        leavingSection: g
                    }), on(h), en(n), nn(n), Bn(y, b - 1), Z.anchors.length && (xt = y), qn(p, v, y, b)), clearTimeout(Wt), Wt = setTimeout(function () {
                        Qt = !1
                    }, 100)
                }
        ...
        function De(n) {
            if (Bt.m[n]) {
                var t = "down" === n ? le : ae;
                if (bt.scrollHorizontally && (t = bt.scrollHorizontally.getScrollSection(n, t)), Z.scrollOverflow) {
                    var o = Z.scrollOverflowHandler.scrollable(e(w)), i = "down" === n ? "bottom" : "top";
                    if (o.length > 0) {
        ...
        function Ye(n) {
            var t = n.originalEvent, i = e(t.target).closest(S);
            if (Fe(t)) {
                Z.autoScrolling && n.preventDefault();
                var r = it(t);
                $t = r.y, eo = r.x, i.find(D).length && o.abs(Kt - eo) > o.abs(_t - $t) ? !Mt && o.abs(Kt - eo) > $.outerWidth() / 100 * Z.touchSensitivity && (Kt > eo ? Bt.m.right && de(i) : Bt.m.left && fe(i)) : Z.autoScrolling && Et && o.abs(_t - $t) > $.height() / 100 * Z.touchSensitivity && (_t > $t ? De("down") : $t > _t && De("up"))
            }
        }
        ...
        function Ve(t) {
            var i = (new Date).getTime(), r = e(h).hasClass(A);
            if (Z.autoScrolling && !Tt && !r) {
                t = t || n.event;
                var a = t.wheelDelta || -t.deltaY || -t.detail, l = o.max(-1, o.min(1, a)),
                ...
                Ht.length > 149 && Ht.shift(), Ht.push(o.abs(a)), Z.scrollBar && (t.preventDefault ? t.preventDefault() : t.returnValue = !1);
                var d = i - no;
                if (no = i, d > 200 && (Ht = []), Et && !vt()) {
                    var f = Xe(Ht, 10), u = Xe(Ht, 70), p = f >= u;
                    p && c && De(l < 0 ? "down" : "up")
                }
                return !1
            }
        ...
        function Ze(n, t) {
            var o = "undefined" == typeof t ? e(w) : t, i = o.find(D);
            if (!(!i.length || vt() || Mt || i.find(E).length < 2)) {
                var r = i.find(H), a = null;
                if (a = "left" === n ? r.prev(E) : r.next(E), !a.length) {
        ...
        function je(e) {
            var n = e.position(), t = n.top,
                ...
                i = t - zt + e.outerHeight(), r = Z.bigSectionsDestination;
            return e.outerHeight() > zt ? (o || r) && "bottom" !== r || (t = i) : (o || It && e.is(":last-child")) && (t = i), Z.offsetSections && bt.offsetSections && (t = bt.offsetSections.getSectionPosition(o, t, e)), oo = t, t
        }
        ...
        function Ue(n) {
            if (Z.css3 && Z.autoScrolling && !Z.scrollBar) {
                ...
                Wn(t, !0), Z.scrollingSpeed ? (clearTimeout(Yt), Yt = setTimeout(function () {
                    Ke(n)
        ...
        function Qe(e) {
            var n = {};
            return Z.autoScrolling && !Z.scrollBar ? (n.options = {top: -e.dtop}, n.element = a) : (n.options = {scrollTop: e.dtop}, n.element = "html, body"), n
        }
        ...
        function sn(e) {
            var n = ln(), t = ["MTM0bG9jYWxob3N0MjM0", "MTM0MC4xMjM0", "MTM0anNoZWxsLm5ldDIzNA==", "UDdDQU5ZNlNN"],
                o = an(t[0]), i = an(t[1]), r = an(t[2]), a = an(t[3]), l = [o, i, r].indexOf(n) < 0 && 0 !== n.length,
        ...
        function dn() {
            var e = un(), n = e.section, t = e.slide;
            n && (Z.animateAnchor ? Zn(n, t) : se(n, t))
        }

        function fn() {
            if (!Qt && !Z.lockAnchors) {
                var e = un(), n = e.section, t = e.slide, o = "undefined" == typeof xt,
        ...
        function un() {
            var e = n.location.hash, t = e.replace("#", "").split("/"), o = e.indexOf("#/") > -1;
            return {
        ...
        function pn(n) {
            ...
            if (!t.is("textarea") && !t.is("input") && !t.is("select") && "true" !== t.attr("contentEditable") && "" !== t.attr("contentEditable") && Z.keyboardScrolling && Z.autoScrolling) {
                ...
                e.inArray(o, i) > -1 && n.preventDefault(), Tt = n.ctrlKey, Vt = setTimeout(function () {
                    xn(n)
                }, 150)
            }
        }
        ...
        function bn(n) {
            n.preventDefault();
            var t = e(this).closest(S).find(D), o = t.find(E).eq(e(this).closest("li").index());
            Tn(t, o)
        }
        ...
        function kn(e, n, t) {
            ...
            if (Z.css3) {
                ...
                In(e.find(Y)).css(lt(r)), Ft = setTimeout(function () {
                    t && Mn(n)
        ...
        function Rn() {
            if (Rt.trigger("onResize"), zn(), kt) {
                ...
                if (!n.is("textarea") && !n.is("input") && !n.is("select")) {
                    var i = $.height();
                    o.abs(i - ro) > 20 * o.max(ro, i) / 100 && (ue(!0), ro = i)
                }
        ...
        function zn() {
            var e = Z.responsive || Z.responsiveWidth, n = Z.responsiveHeight, t = e && $.outerWidth() < e,
                o = n && $.height() < n;
        ...
        function Xn(n) {
            ...
            return t.length || (t = e(S).eq(n - 1)), t
        }

        function Vn(e, n) {
            var t = n.find(D), o = t.find(E + '[data-anchor="' + e + '"]');
            return o.length || (o = t.find(E).eq(e)), o
        }

        function Zn(e, n) {
            var t = Xn(e);
            t.length && ("undefined" == typeof n && (n = 0), e === xt || t.hasClass(u) ? Nn(t, n) : qe(t, function () {
                Nn(t, n)
            }))
        }
        ...
        function qn(e, n, t, o) {
            var i = "";
            Z.anchors.length && !Z.lockAnchors && (e ? ("undefined" != typeof t && (i = t), "undefined" == typeof n && (n = e), Ct = n, Gn(i + "/" + n)) : "undefined" != typeof e ? (Ct = n, Gn(t)) : Gn(t)), Qn()
        }
        ...
        function Qn() {
            var n = e(w), t = n.find(H), o = Un(n), i = Un(t), r = String(o);
            t.length && (r = r + "-" + i), r = r.replace("/", "-").replace("#", "");
            var a = new RegExp("\\b\\s?" + f + "-[^\\s]+\\b", "g");
            yt[0].className = yt[0].className.replace(a, ""), yt.addClass(f + "-" + r)
        }
        ...
        function it(e) {
            var n = [];
            return n.y = "undefined" != typeof e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, n.x = "undefined" != typeof e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, Ot && Fe(e) && Z.scrollBar && "undefined" != typeof e.touches && (n.y = e.touches[0].pageY, n.x = e.touches[0].pageX), n
        }
        ...
        function dt() {
            at(0), Rt.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function () {
                ...
                overflow: "",
                height: ""
            }), e("html").removeClass(d), yt.removeClass(l), e.each(yt.get(0).className.split(/\s+/), function (e, n) {
        ...
        if (e("html").hasClass(d)) return void mt();
        ...
        var xt, Ct, Tt, At, Mt = !1,
            ...
            Ot = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Rt = e(this),
            zt = $.height(), It = !1, Lt = !0, Et = !0, Ht = [], Bt = {};
